...
GET /users | https://storemanagerapi2.herokuapp.com/api/v2/users | Get all users
GET /users/userid | https://storemanagerapi2.herokuapp.com/api/v2/users/<int: userid> | Get a single user
...
PUT /products/id| https://storemanagerapi2.herokuapp.com/api/v2/products/<int: productid> | UPDATE a product
DELETE /products/id| https://storemanagerapi2.herokuapp.com/api/v2/products/<int: productid> | DELETE a product
